...
//	        driver.findElement(By.partialLinkText("Forgot your")).click();
		...
		// css selector1.id 2.class 3.attribute 4.multiple attribute
		// 5.parent child
...
//	        driver.findElement(By.cssSelector("input#gender-radio-2[name=\"gender\"]")).click();
		...
		// css by parent-child ==syntax==> (parentnode>childnode[childnode
		// attribute="value"])
		...
		driver.findElement(
				By.cssSelector("div[class=\"react-datepicker__day react-datepicker__day--020\"]"))
				.click();
